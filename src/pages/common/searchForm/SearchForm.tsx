...
const SearchForm = () => {
    ...
    const lineRef: Ref<any> = useRef(null)
    ...
    const onSubmit = (data: any) => {
        ...
        dispatch(aukroGoodsFetch(payloadAukro)).then(() => scrollIntoLine())
    };
    ...
    return (
        <div className={clsx('pb-4')}>
                ...
                <Card.Body>
                    <div className={clsx('d-flex', 'flex-column', 'gap-3', 'p-5')}>
                        ...
                        <div className={clsx('d-flex', 'justify-content-center', 'mb-5')}>
                            <h6 className={clsx('text-center', 'w-50', 'text-primary')}>Hledejte bazarové zboží najednou
                                ve všech nejznámějších a
                            ...
                            <div className='d-flex flex-column gap-5'>
                                ...
                                <div className={clsx('d-flex', 'justify-content-center')}>
                                    <Button
                                        ...
                                        type='submit'
                                    >
                                        <span>Hledat</span><Search className={clsx('align-self-center')}/>
                                    </Button>
                                </div>
                            </div>
                        </Form>
            ...
            <FeaturesSection/>
            <div className={clsx('w-100', 'underline-primary', 'mb-5', 'pb-5')} ref={lineRef}></div>
        </div>
    );
}
